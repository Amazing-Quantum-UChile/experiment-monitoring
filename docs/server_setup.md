...
We now check if the code work. We will tell the database to do 1 measurement
```
...
# Table of Contents
- [1. Introduction to Experiment Monitoring Server Setup](#1-introduction-to-experiment-monitoring-server-setup)
- [2. Install Python dependencies](#2-install-python-dependencies)
- [3. Installing Influx dB](#3-installing-influx-db)
- [4. Installing Grafana](#4-installing-grafana)
- [5. Install Experiment Monitoring](#5-install-experiment-monitoring)
- [6. Setting up the InfluxDB database and the code](#6-setting-up-the-influxdb-database-and-the-code)
      - [7. Check that it works and setting up the service](#7-check-that-it-works-and-setting-up-the-service)
